...
- Renders read output in a file-card surface that mirrors the edit/patch/write diff chrome: bordered wrapper, sticky `bg-(--bg-key)` header strip, file icon, and scrollable monospace body.
