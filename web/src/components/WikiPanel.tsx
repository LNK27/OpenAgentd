      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="mobile-safe-notch-top fixed inset-x-0 bottom-0 z-50 flex flex-col overflow-hidden border-(--color-border) bg-(--bg-card) shadow-2xl sm:left-1/2 sm:top-1/2 sm:inset-auto sm:h-[min(90vh,860px)] sm:w-[min(90vw,1180px)] sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-lg sm:border"
            role="dialog"
            aria-modal="true"
            aria-label="Wiki"
