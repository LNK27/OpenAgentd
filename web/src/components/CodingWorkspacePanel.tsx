...
export function CodingWorkspacePanel({
  ...
  return (
    <motion.aside
      ...
      className={cn('fixed inset-y-0 right-0 z-40 min-h-0 w-full overflow-hidden border-l border-(--color-border) bg-(--bg-page) shadow-xl sm:relative sm:z-auto sm:w-auto sm:shrink-0 sm:shadow-none', mobile ? 'max-w-none' : 'max-w-[440px]')}
    >
