...
export function CodingWorkspacePanel({
  ...
  return (
    <motion.aside
      ...
      className={cn('fixed inset-y-0 right-0 z-40 min-h-0 w-full overflow-hidden border-l border-(--color-border) bg-(--bg-page) shadow-xl md:relative md:z-auto md:w-auto md:shrink-0 md:shadow-none', mobile ? 'max-w-none' : 'max-w-[440px]')}
    >
