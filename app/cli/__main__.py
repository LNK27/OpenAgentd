...
The two ``sys.stderr.write`` lines below look pointless but are not.
...
``timed out waiting for handshake`` in ``OpenAgentd.log``.
...
Tauri's 30 s handshake timeout.  Issuing an immediate flush forces
